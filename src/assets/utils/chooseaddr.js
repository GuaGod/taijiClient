...
function showCity(obj) {
    ...
    if (val != currentCity.prov) {
        currentCity.prov = val;
    }
    if (val != null) {
        city.length = 1;
...
function showCountry(obj) {
    ...
    if (val != null) {
        country.length = 1;
        var countryLen = provice[currentCity.prov]["city"][val].districtAndCounty.length;
        if(countryLen == 0){
            addrShow.value = provice[currentCity.prov].name + '-' + provice[currentCity.prov]["city"][currentCity.city].name;
            return;
        }
        for (var n = 0; n < countryLen; n++) {
            var countryOpt = document.createElement('option');
            countryOpt.innerText = provice[currentCity.prov]["city"][val].districtAndCounty[n];
            countryOpt.value = n;
...
function selecCountry(obj) {
    currentCity.country = obj.options[obj.selectedIndex].value;
